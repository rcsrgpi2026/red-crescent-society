...
এর মূল লক্ষ্য আর্তমানবতার সেবা, স্বেচ্ছায় রক্তদান উৎসাহিত করা, দুর্যোগ মোকাবিলায় প্রস্তুতি এবং শিক্ষার্থীদের নেতৃত্ব ও মানবিক মূল্যবোধে গড়ে তোলা। এটি একটি অরাজনৈতিক ও নিরপেক্ষ ছাত্র সংগঠন।`,
  ...
  {
    id: "contact-and-office",
    titleBn: "যোগাযোগ, অফিশিয়াল ইমেইল ও ঠিকানা",
    category: "about",
    keywords: [
      "contact",
      "email",
    ...
    contentBn: `বাংলাদেশ রেড ক্রিসেন্ট সোসাইটি, আরজিপিআই ইউনিটের অফিশিয়াল যোগাযোগের তথ্য:
- অফিশিয়াল ইমেইল ঠিকানা: redcrescentyouthrgpi@gmail.com
- জরুরি হটলাইন ও ফোন নম্বর: 01614424259
- কার্যালয় ও ক্যাম্পাস ঠিকানা: রাজশাহী পলিটেকনিক ইনস্টিটিউট (RGPI), রাজশাহী, বাংলাদেশ।
- যোগাযোগের ওয়েব পেজ: '/contact' (এখানে সরাসরি মেসেজ পাঠানোর ফর্ম রয়েছে)।`,
  },
  {
    id: "seven-principles",
...
৬. সতর্কতা: রক্তদানের সময় জ্বর, সর্দি বা কোনো অ্যান্টিবায়োটিক বা দীর্ঘমেয়াদি ওষুধের সেবন থাকলে রক্তদান সাময়িকভাবে স্থগিত রাখতে হবে।`,
  },
  {
    ...
    contentBn: `যুব রেড ক্রিসেন্ট আরজিপিআই-এর স্বেচ্ছাসেবক নিয়োগ ও রিক্রুটমেন্ট নিয়মাবলী:
...
৪. আবেদনের পর প্রাথমিক বাছাই ও মৌখিক সাক্ষাতকারের মাধ্যমে নির্বাচিত স্বেচ্ছাসেবকদের ওরিয়েন্টেশন ও পরিচয়পত্র প্রদান করা হয়।`,
  ...
  {
    id: "rcy-member-registration",
    titleBn: "RCY মেম্বার পোর্টাল নিবন্ধন পদ্ধতি",
    category: "volunteer",
    keywords: [
      "rcy member registration",
      "member registration",
      "member regestration",
      "member registration er step",
    ...
    contentBn: `যুব রেড ক্রিসেন্ট (RCY RGPI)-এর সদস্য/ভলান্টিয়ার পোর্টাল অ্যাকাউন্ট খোলার ধাপসমূহ:
১. ব্রাউজার থেকে সরাসরি '/volunteer/login' লিংকে প্রবেশ করুন।
২. পেজের উপরের সুইচবারে 'Create account' ট্যাবে ক্লিক করুন।
৩. ফর্মে আপনার পুরো নাম, রাজশাহী পলিটেকনিকের বোর্ড/ক্লাস রোল নম্বর, রেজিস্ট্রেশন নম্বর, সেশন (Session) ও টেকনোলজি/বিভাগ নির্বাচন করুন।
৪. আপনার সচল মোবাইল নম্বর, ইমেইল ঠিকানা, রক্তের গ্রুপ এবং জরুরি যোগাযোগের তথ্য প্রদান করুন।
৫. একটি শক্তিশালী পাসওয়ার্ড দিয়ে 'Create account' বাটনে চাপ দিন।
৬. অ্যাকাউন্ট সফলভাবে তৈরির পর ইউনিট অ্যাডমিন/নেতৃত্ব কর্তৃক আপনার তথ্য ভেরিফাই করে অনুমোদন (Approval) দেওয়া হয়।
(নোট: আপনি যদি নতুন স্বেচ্ছাসেবক হিসেবে অফিসিয়াল রিক্রুটমেন্টে অংশ নিতে চান, তবে বার্ষিক ক্যাম্পেইন চলাকালীন '/apply-volunteer' পেজে আবেদন করতে হয়। সাধারণ শিক্ষার্থীদের জন্য রয়েছে '/student/login'।)`,
  },
  {
