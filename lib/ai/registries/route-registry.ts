...
export const RCY_ROUTES: RcyRoute[] = [
  ...
  },
  {
    ...
    titleBn: "স্বেচ্ছাসেবক পোর্টাল লগইন",
    description: "Access volunteer dashboard, assigned tasks, and event participation.",
    descriptionBn: "স্বেচ্ছাসেবকদের নিজস্ব ড্যাশবোর্ড ও ইভেন্ট অংশগ্রহণের পোর্টাল।",
    keywords: ["volunteer login", "volunteer portal", "স্বেচ্ছাসেবক লগইন", "ভলান্টিয়ার পোর্টাল"],
    isPublic: true,
    requiresAuth: false,
    category: "portal",
  },
